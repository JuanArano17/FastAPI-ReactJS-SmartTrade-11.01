...
from schemas.in_shopping_cart import InShoppingCart, InShoppingCartCreate, InShoppingCartUpdate
...
shopping_cart_service=InShoppingCartService(session=session,buyer_service=buyer_service, seller_product_service=seller_product_service)
...
async def create_cart_item(*, buyer_id: int ,shopping_cart_product: InShoppingCartCreate):
    """
    Create a new shopping cart item for the buyer.
    """
    return shopping_cart_service.add(id_buyer=buyer_id,shopping_cart_product=shopping_cart_product)
...
async def update_quantity(*, buyer_id=int, seller_product_id: int, cart_item: InShoppingCartUpdate):
    """

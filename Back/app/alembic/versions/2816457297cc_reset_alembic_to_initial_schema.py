"""reset alembic to initial schema

Revision ID: 2816457297cc
Revises:
Create Date: 2024-05-13 00:23:38.132344
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id_buyer", sa.Integer(), nullable=False),
        sa.Column("quantity", sa.Integer(), nullable=False),
        sa.Column("id_size", sa.Integer(), nullable=True),
        sa.ForeignKeyConstraint(
        ...
        sa.ForeignKeyConstraint(
            ["id_size"], ["Size.id"], name="fk_cart_size_id", ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
